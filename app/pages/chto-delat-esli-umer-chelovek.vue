...
const documents = [
  ...
  'Документы умершего, которые потребуются по обстоятельствам конкретной ситуации.',
  'Медицинские и иные подтверждающие документы, если они запрашиваются по месту оформления.',
]
